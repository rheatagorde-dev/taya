<x-guest-layout>
    <div class="text-center mb-8">
        <h2 class="text-xl font-bold text-white tracking-tight">Create Account</h2>
        <p class="text-sm text-white/40 mt-1">Register for a new TAYA account</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Confirm Password -->
        <div class="mb-6">
            <label for="password_confirmation" class="block text-sm font-medium text-white/70 mb-2">Confirm Password</label>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                    <svg class="w-5 h-5 text-white/30" fill="none" stroke="currentColor" viewBox="0 0 24 24">
